...
export const calcInPathPoints = ({ context, lineHeight, bbox, yOffset, padding, minWidth }) => {
    ...
    if (yOffset + lineHeight <= bbox.height) {
        ...
        if (inPath.topLeft && inPath.topRight && inPath.bottomRight && inPath.bottomLeft) {
            ...
            if (lineData.width >= minWidth) {
                ...
                return calcInPathPoints(context, lineHeight, bbox, yOffset + 1, padding, minWidth, path);
            }
