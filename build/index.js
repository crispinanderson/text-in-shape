...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"appendContPuncuation\", function() { return appendContPuncuation; });\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ \"./src/utils.js\");\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\nvar appendContPuncuation = function appendContPuncuation(lineData, options) {\n  var appended = _objectSpread({}, lineData); //Add the punctuation\n\n\n  appended.textContent = !appended.textContent.includes('...') ? appended.textContent += '...' : appended.textContent;\n  appended.textWidth = Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"calcSentenceWidth\"])(appended.textContent, options); //If the length would overrun the container with the punction added, remove the last word\n\n  if (Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"calcSentenceWidth\"])(appended.textContent, options) > appended.width - options.padding.right) {\n    appended.textContent = appended.textContent.trim().replace(/\\w([^\\w+]*)$/, '');\n    appended.textContent = appended.textContent.trim().replace(/\\s(\\w+)$/, '...');\n    appended.textWidth = Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"calcSentenceWidth\"])(appended.textContent, options); //Recursively test theat the line does not overrun - remove words as neccesary\n\n    return appendContPuncuation(appended, options);\n  }\n\n  return appended;\n};\n\n//# sourceURL=webpack:///./src/addTextContentToLineData/appendContPuncuation.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"createRenderData\", function() { return createRenderData; });\n/* harmony import */ var _svgElementToCanvas__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./svgElementToCanvas */ \"./src/svgElementToCanvas.js\");\n/* harmony import */ var _calcLineAlignment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./calcLineAlignment */ \"./src/calcLineAlignment.js\");\n/* harmony import */ var _calcTextJustification__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./calcTextJustification */ \"./src/calcTextJustification.js\");\n/* harmony import */ var _calcLinePositions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./calcLinePositions */ \"./src/calcLinePositions/index.js\");\n/* harmony import */ var _addTextContentToLineData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./addTextContentToLineData */ \"./src/addTextContentToLineData/index.js\");\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils */ \"./src/utils.js\");\n\n\n\n\n\n\nvar createRenderData = function createRenderData(text, svgElement, options) {\n  var context = Object(_svgElementToCanvas__WEBPACK_IMPORTED_MODULE_0__[\"svgElementToCanvas\"])(svgElement);\n  var lineHeight = Object(_utils__WEBPACK_IMPORTED_MODULE_5__[\"getLineHeight\"])(options);\n  var lineData = Object(_calcLinePositions__WEBPACK_IMPORTED_MODULE_3__[\"calcLinePositions\"])({\n    lineHeight: lineHeight,\n    context: context,\n    svgElement: svgElement,\n    options: options,\n    text: text\n  });\n  var lineDataWithText = Object(_addTextContentToLineData__WEBPACK_IMPORTED_MODULE_4__[\"addTextContentToLineData\"])({\n    lineHeight: lineHeight,\n    text: text,\n    lineData: lineData,\n    options: options\n  });\n  var lineDataJustified = options.justifyText ? Object(_calcTextJustification__WEBPACK_IMPORTED_MODULE_2__[\"calcTextJustification\"])(options, lineDataWithText) : lineDataWithText;\n  var lineDataAligned = options.justifyText ? lineDataJustified : Object(_calcLineAlignment__WEBPACK_IMPORTED_MODULE_1__[\"calcLineAlignment\"])(options, lineDataJustified);\n  Object(_svgElementToCanvas__WEBPACK_IMPORTED_MODULE_0__[\"destroyCanvas\"])();\n  return lineDataAligned;\n};\n\n//# sourceURL=webpack:///./src/createRenderData.js?");
